...
- [x] [Правила поведения зрителей при проведении официальных спортивных соревнований](http://www.consultant.ru/document/cons_doc_LAW_155773/9084b9e2db33906891ff7be52b97404354769e88/) с учётом [правил поведения зрителей при проведении домашних матчей ФК «Зенит»](https://tickets.fc-zenit.ru/info/behavior_rules/football/)<br><small>
  ...
  **Подсказка:** Подробнее о правилах можно почитать [:material-arrow-right: здесь](../../articles/rules/rights).
</small>
...
- [x] Запрещённые знаки и символы, утвержденные [:material-book-open-page-variant: брошюрой FARE международной федерации футбола (FIFA) на европейских и международных матчах](../../articles/rules/prohibited_symbols) и утвержденные [:material-link: Дисциплинарным регламентом РФС (приложение 2) на матчах РПЛ и Кубка России](https://static.rfs.ru/documents/1/5f22dbb913c1f.pdf). 
</div>
